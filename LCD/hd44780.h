...
// пины управления и данных можно посадить на разные порты
// внимательно выбирать выводы (если выводы заняты, например JTAG-ом, то они работать не будут)
...
#define PORT_DATA_RCC RCC_APB2Periph_GPIOB

#define DB4 GPIO_Pin_9
#define DB5 GPIO_Pin_8
#define DB6 GPIO_Pin_7
